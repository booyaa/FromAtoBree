...
function createGraph(options) {
  ...
  console.log("createGraph options: %j", options);
  ...
  console.log("graph west bree: %j", graph["West Bree"]);
  console.log("graph ost forod: %j", graph["Ost Forod"]);
  console.log("graph kauppa: %j", graph["Kauppa-kohta"]);
  return graph;
}
